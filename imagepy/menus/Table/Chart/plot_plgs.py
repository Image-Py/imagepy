...
class Plot(Table):
    ...
    def run(self, tps, snap, data, para=None):
        ...
        data[para["cn"]].plot(
            lw=para["lw"], grid=para["grid"], title=para["title"], ax=plt.add_subplot()
        )
        plt.Show()
...
class Pie(Table):
    ...
    para = {"cn": [], "title": ""}
    asyn = False
    view = [(str, "title", "title", ""), ("fields", "cn", "select fields")]

    def run(self, tps, snap, data, para=None):
        plt = self.app.show_plot(para["title"])
        data[para["cn"]].plot.pie(
            subplots=True, title=para["title"], ax=plt.add_subplot()
        )
        plt.Show()

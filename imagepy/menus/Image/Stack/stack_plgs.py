...
class SetSlice(Simple):
    ...
    def load(self, ips):
        self.view = [
            (int, "num", (0, ips.slices - 1), 0, "Num", "0~%d" % (ips.slices - 1))
        ]
        return True
...
class Sub(Simple):
    ...
    view = [
        (int, "start", (0, 1e8), 0, "start", "slice"),
        (int, "end", (0, 1e8), 0, "end", "slice"),
    ]

    def load(self, ips):
        self.view = [
            (int, "start", (0, ips.slices - 1), 0, "start", "0~%d" % (ips.slices - 1)),

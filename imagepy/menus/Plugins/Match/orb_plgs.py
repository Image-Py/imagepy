...
class OrbMatch(Simple):
    ...
    #parameter
    para = {'img1':'','img2':'',  'log':False, 'int':4, 'num':200, 'style':'Blue/Yellow',
            'tab':True,'com':True}
    ...
    def run(self, ips, imgs, para = None):
        ...
        mask = np.ones(matches12[:, 1].shape,dtype=np.int8)

        print('mask:{}'.format(mask.shape))
        print('matches12:{}'.format(matches12))

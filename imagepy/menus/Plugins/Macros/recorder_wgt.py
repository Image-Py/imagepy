...
class Plugin(wx.Panel):
    ...
    def __init__(self, parent, app=None):
        ...
        self.tol_open = self.toolbar.AddTool(
            wx.ID_ANY,
            u"tool",
            wx.Bitmap(osp.join(root, "icons/open.png"), wx.BITMAP_TYPE_ANY),
            wx.NullBitmap,
            wx.ITEM_NORMAL,
            wx.EmptyString,
            wx.EmptyString,
        ...
        self.m_save = self.toolbar.AddTool(
            wx.ID_ANY,
            u"tool",
            wx.Bitmap(osp.join(root, "icons/save.png"), wx.BITMAP_TYPE_ANY),
            wx.NullBitmap,
            wx.ITEM_NORMAL,
            wx.EmptyString,
            wx.EmptyString,
        ...
        self.tol_cut = self.toolbar.AddTool(
            wx.ID_ANY,
            u"tool",
            wx.Bitmap(osp.join(root, "icons/cut.png"), wx.BITMAP_TYPE_ANY),
            wx.NullBitmap,
            wx.ITEM_NORMAL,
            wx.EmptyString,
            wx.EmptyString,
        ...
        self.m_copy = self.toolbar.AddTool(
            wx.ID_ANY,
            u"tool",
            wx.Bitmap(osp.join(root, "icons/copy.png"), wx.BITMAP_TYPE_ANY),
            wx.NullBitmap,
            wx.ITEM_NORMAL,
            wx.EmptyString,
            wx.EmptyString,
        ...
        self.m_paste = self.toolbar.AddTool(
            wx.ID_ANY,
            u"tool",
            wx.Bitmap(osp.join(root, "icons/paste.png"), wx.BITMAP_TYPE_ANY),
            wx.NullBitmap,
            wx.ITEM_NORMAL,
            wx.EmptyString,
            wx.EmptyString,
        ...
        self.m_delete = self.toolbar.AddTool(
            wx.ID_ANY,
            u"tool",
            wx.Bitmap(osp.join(root, "icons/delete.png"), wx.BITMAP_TYPE_ANY),
            wx.NullBitmap,
            wx.ITEM_NORMAL,
            wx.EmptyString,
            wx.EmptyString,
        ...
        self.m_run = self.toolbar.AddTool(
            wx.ID_ANY,
            u"tool",
            wx.Bitmap(osp.join(root, "icons/play.png"), wx.BITMAP_TYPE_ANY),
            wx.NullBitmap,
            wx.ITEM_NORMAL,
            wx.EmptyString,
            wx.EmptyString,
        ...
        self.tol_runlines = self.toolbar.AddTool(
            wx.ID_ANY,
            u"tool",
            wx.Bitmap(osp.join(root, "icons/runlines.png"), wx.BITMAP_TYPE_ANY),
            wx.NullBitmap,
            wx.ITEM_NORMAL,
            wx.EmptyString,
            wx.EmptyString,
        ...
        self.m_record = self.toolbar.AddTool(
            wx.ID_ANY,
            u"tool",
            wx.Bitmap(osp.join(root, "icons/record.png"), wx.BITMAP_TYPE_ANY),
            wx.NullBitmap,
            wx.ITEM_RADIO,
            wx.EmptyString,
            wx.EmptyString,
        ...
        self.m_pause = self.toolbar.AddTool(
            wx.ID_ANY,
            u"tool",
            wx.Bitmap(osp.join(root, "icons/pause.png"), wx.BITMAP_TYPE_ANY),
            wx.NullBitmap,
            wx.ITEM_RADIO,
            wx.EmptyString,
            wx.EmptyString,
    ...
    def on_save(self, event):
        if self.file == "":
            filt = "|".join(
                ["%s files (*.%s)|*.%s" % (i.upper(), i, i) for i in ["mc"]]
            )

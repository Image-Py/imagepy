...
class VirtualListCtrl(wx.ListCtrl):
    def __init__(self, parent, title, data=[]):
        wx.ListCtrl.__init__(
            self,
            parent,
            style=wx.LC_REPORT | wx.LC_SINGLE_SEL | wx.LC_VIRTUAL | wx.LC_EDIT_LABELS,
        )
...
class Plugin(wx.Panel):
    ...
    def __init__(self, parent, app=None):
        ...
        self.note_book = wx.Notebook(
            self, wx.ID_ANY, wx.DefaultPosition, wx.DefaultSize, wx.NB_LEFT | wx.NB_TOP
        )
        # self.note_book = wx.Choicebook( self, wx.ID_ANY, wx.DefaultPosition, wx.DefaultSize, wx.CHB_DEFAULT )
        self.pan_manage = wx.Panel(
            self.note_book,
            wx.ID_ANY,
            wx.DefaultPosition,
            wx.DefaultSize,
        ...
        self.btn_add = wx.Button(
            self.pan_manage, wx.ID_ANY, u"Add", wx.DefaultPosition, wx.DefaultSize, 0
        )
        sizer_manage.Add(self.btn_add, 0, wx.LEFT | wx.RIGHT | wx.TOP, 5)

        self.btn_load = wx.Button(
            self.pan_manage, wx.ID_ANY, u"Load", wx.DefaultPosition, wx.DefaultSize, 0
        )
        sizer_manage.Add(self.btn_load, 0, wx.ALL, 5)

        self.btn_update = wx.Button(
            self.pan_manage, wx.ID_ANY, u"Update", wx.DefaultPosition, wx.DefaultSize, 0
        )
        sizer_manage.Add(self.btn_update, 0, wx.ALL, 5)

        self.btn_remove = wx.Button(
            self.pan_manage, wx.ID_ANY, u"Remove", wx.DefaultPosition, wx.DefaultSize, 0
        )
        sizer_manage.Add(self.btn_remove, 0, wx.ALL, 5)

        self.btn_open = wx.Button(
            self.pan_manage, wx.ID_ANY, u"Open", wx.DefaultPosition, wx.DefaultSize, 0
        )
        sizer_manage.Add(self.btn_open, 0, wx.ALL, 5)

        self.btn_save = wx.Button(
            self.pan_manage, wx.ID_ANY, u"Save", wx.DefaultPosition, wx.DefaultSize, 0
        )
        ...
        self.btn_bound = wx.Button(
            self.pan_operate, wx.ID_ANY, u"Bound", wx.DefaultPosition, wx.DefaultSize, 0
        )
        sizer_operate.Add(self.btn_bound, 0, wx.ALL, 5)

        self.btn_clip = wx.Button(
            self.pan_operate, wx.ID_ANY, u"Clip", wx.DefaultPosition, wx.DefaultSize, 0
        )
        sizer_operate.Add(self.btn_clip, 0, wx.ALL, 5)

        self.btn_invert = wx.Button(
            self.pan_operate,
            wx.ID_ANY,
            u"Invert",
            wx.DefaultPosition,
        ...
        self.btn_sketch = wx.Button(
            self.pan_draw, wx.ID_ANY, u"Sketch", wx.DefaultPosition, wx.DefaultSize, 0
        )
        sizer_draw.Add(self.btn_sketch, 0, wx.ALL, 5)

        self.btn_clear = wx.Button(
            self.pan_draw, wx.ID_ANY, u"Clear", wx.DefaultPosition, wx.DefaultSize, 0
        )
        sizer_draw.Add(self.btn_clear, 0, wx.ALL, 5)

        self.btn_clearout = wx.Button(
            self.pan_draw,
            wx.ID_ANY,
            u"Clear Out",
            wx.DefaultPosition,
        ...
        self.btn_setting = wx.Button(
            self.pan_draw, wx.ID_ANY, u"Setting", wx.DefaultPosition, wx.DefaultSize, 0
        )
        ...
        self.info = wx.StaticText(
            self, wx.ID_ANY, "Information", wx.DefaultPosition, wx.DefaultSize
        )
    ...
    def AddEvent(self):
        ...
        self.btn_inflate.Bind(
            wx.EVT_ENTER_WINDOW, lambda e: self.info.SetLabel("inflate the current roi")
        )
        self.btn_shrink.Bind(wx.EVT_BUTTON, self.on_shrink)
        self.btn_shrink.Bind(
            wx.EVT_ENTER_WINDOW, lambda e: self.info.SetLabel("shrink the current roi")
        )
        self.btn_convex.Bind(wx.EVT_BUTTON, self.on_convex)
        self.btn_convex.Bind(
            wx.EVT_ENTER_WINDOW,
    ...
    def on_load(self, event):
        ...
        if idx == -1:
            return self.app.alert("No ROI Selected!")

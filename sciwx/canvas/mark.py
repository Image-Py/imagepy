...
lines = {
    ...
    "lw": 1,
    "style": "-",
    "body": [[(10, 10), (100, 200), (200, 200)], [(150, 10), (50, 250)]],
}
polygon = {
    "type": "polygon",
    "color": (255, 0, 0),
...
polygons = {
    ...
    "lw": 1,
    "style": "o",
    "body": [[(10, 10), (100, 200), (200, 200)], [(150, 10), (50, 250), (288, 0)]],
}
circle = {
    "type": "circle",
    "color": (255, 0, 0),
...
ellipses = {
    ...
    "fcolor": (255, 255, 0),
    "fill": False,
    "body": [(100, 100, 100, 50, 1), (200, 250, 50, 100, 3.14)],
}
rectangle = {
    "type": "rectangle",
    "color": (255, 0, 0),
...
rectangles = {
    ...
    "fcolor": (255, 255, 0),
    "fill": False,
    "body": [(100, 100, 80, 50), (200, 200, 80, 100)],
}
text = {
    "type": "text",
    "color": (255, 255, 0),
...
texts = {
    ...
    "lw": 8,
    "fill": True,
    "body": [(100, 200, "id=0"), (180, 250, "id=1")],
}
...
def cross(ori, cont, win, cell):
    ...
    ox = cont[0] - ori[0] * kx
    oy = cont[1] - ori[1] * kx
    cell = [cell[0] * kx + ox, cell[1] * ky + oy, cell[2] * kx + ox, cell[3] * kx + oy]
    if cell[0] > win[2] or cell[2] < win[0]:
        return 0
    if cell[1] > win[3] or cell[3] < win[1]:
        return 0
...
def make_ellipse(l1, l2, ang):
    m = np.array([[l1 * cos(-ang), -l2 * sin(-ang)], [l1 * sin(-ang), l2 * cos(-ang)]])
...
def draw_rectangle(pts, dc, f, **key):
    ...
    if pts.dtype == "rectangle":
        ...
        w, h = f(x + w, y + h)
        x, y = f(x, y)
        dc.DrawRectangle(x.round(), (y).round(), (w - x).round(), (h - y).round())

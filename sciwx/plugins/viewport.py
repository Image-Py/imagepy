...
class ViewPort(wx.Panel):
    ...
    def __init__(self, parent, app):
        ...
        self.slider = wx.Slider(
            ...
            wx.DefaultPosition,
            wx.DefaultSize,
            wx.SL_LEFT | wx.SL_VERTICAL | wx.SL_SELRANGE | wx.SL_INVERSE,
        )
        ...
        self.btn_fit = wx.Button(
            self, wx.ID_ANY, u"Fit", wx.DefaultPosition, wx.DefaultSize, wx.BU_EXACTFIT
        )
        self.btn_fit.SetMaxSize(wx.Size(-1, 40))

        bSizer2.Add(self.btn_fit, 0, wx.ALL, 5)

        self.btn_one = wx.Button(
            self,
            wx.ID_ANY,
            u"Normal",
            wx.DefaultPosition,
        ...
        self.label = wx.StaticText(
            self, wx.ID_ANY, u" 100.00%", wx.DefaultPosition, wx.DefaultSize, 0
        )
        self.label.Wrap(-1)

...
class MCanvas3D(wx.Panel):
    def __init__(self, parent, scene=None):
        ...
        self.btn_x = wx.BitmapButton(
            ...
            wx.ID_ANY,
            make_bitmap(
                wx.Bitmap(osp.join(root, "imgs/x-axis.png"), wx.BITMAP_TYPE_ANY)
            ),
            wx.DefaultPosition,
            wx.DefaultSize,
            wx.BU_AUTODRAW,
        ...
        self.btn_y = wx.BitmapButton(
            ...
            wx.ID_ANY,
            make_bitmap(
                wx.Bitmap(osp.join(root, "imgs/y-axis.png"), wx.BITMAP_TYPE_ANY)
            ),
            wx.DefaultPosition,
            wx.DefaultSize,
            wx.BU_AUTODRAW,
        ...
        self.btn_z = wx.BitmapButton(
            ...
            wx.ID_ANY,
            make_bitmap(
                wx.Bitmap(osp.join(root, "imgs/z-axis.png"), wx.BITMAP_TYPE_ANY)
            ),
            wx.DefaultPosition,
            wx.DefaultSize,
            wx.BU_AUTODRAW,
        ...
        self.btn_pers = wx.BitmapButton(
            ...
            wx.ID_ANY,
            make_bitmap(
                wx.Bitmap(osp.join(root, "imgs/isometric.png"), wx.BITMAP_TYPE_ANY)
            ),
            wx.DefaultPosition,
            wx.DefaultSize,
            wx.BU_AUTODRAW,
        ...
        self.btn_orth = wx.BitmapButton(
            ...
            wx.ID_ANY,
            make_bitmap(
                wx.Bitmap(osp.join(root, "imgs/parallel.png"), wx.BITMAP_TYPE_ANY)
            ),
            wx.DefaultPosition,
            wx.DefaultSize,
            wx.BU_AUTODRAW,
        ...
        self.btn_open = wx.BitmapButton(
            self.toolbar,
            wx.ID_ANY,
            make_bitmap(wx.Bitmap(osp.join(root, "imgs/open.png"), wx.BITMAP_TYPE_ANY)),
            wx.DefaultPosition,
            wx.DefaultSize,
            wx.BU_AUTODRAW,
        )
        ...
        self.btn_stl = wx.BitmapButton(
            self.toolbar,
            wx.ID_ANY,
            make_bitmap(wx.Bitmap(osp.join(root, "imgs/stl.png"), wx.BITMAP_TYPE_ANY)),
            wx.DefaultPosition,
            wx.DefaultSize,
            wx.BU_AUTODRAW,
        )
        ...
        self.cho_light = wx.Choice(
            ...
            wx.DefaultPosition,
            wx.DefaultSize,
            ["force light", "normal light", "weak light", "off light"],
            0,
        )
        ...
        self.spn_dirv = wx.SpinButton(
            self.toolbar, wx.ID_ANY, wx.DefaultPosition, wx.DefaultSize, 0
        )
        tsizer.Add(self.spn_dirv, 0, wx.ALL | wx.EXPAND, 1)
        self.spn_dirh = wx.SpinButton(
            self.toolbar,
            wx.ID_ANY,
            wx.DefaultPosition,
            wx.DefaultSize,
        ...
        self.settingbar = wx.Panel(
            self, wx.ID_ANY, wx.DefaultPosition, wx.DefaultSize, wx.TAB_TRAVERSAL
        )
        ssizer = wx.BoxSizer(wx.HORIZONTAL)

        cho_objChoices = [""]
        self.cho_obj = wx.Choice(
            self.settingbar,
            wx.ID_ANY,
            wx.DefaultPosition,
            wx.DefaultSize,
        ...
        self.cho_hlight = wx.Choice(
            self.settingbar,
            wx.ID_ANY,
            wx.DefaultPosition,
            wx.DefaultSize,
            ["force specular", "normal specular", "weak specular", "off specular"],
            0,
        )
        self.cho_hlight.SetSelection(3)
        ssizer.Add(self.cho_hlight, 0, wx.ALIGN_CENTER | wx.ALL, 1)

        self.col_color = wx.ColourPickerCtrl(
            self.settingbar,
            wx.ID_ANY,
            wx.BLACK,
            wx.DefaultPosition,
        ...
        self.m_staticText2 = wx.StaticText(
            self.settingbar, wx.ID_ANY, u"Alpha:", wx.DefaultPosition, wx.DefaultSize, 0
        )
        self.m_staticText2.Wrap(-1)
        ssizer.Add(self.m_staticText2, 0, wx.ALIGN_CENTER | wx.LEFT, 10)

        self.sli_alpha = wx.Slider(
            self.settingbar,
            wx.ID_ANY,
            10,
            0,
        ...
        self.on_bgcolor = lambda e: self.canvas.scene3d.set_style(
            bg_color=tuple(np.array(e.GetColour()[:3]) / 255)
        )
        self.on_bg = lambda e: self.canvas.scene3d.set_style(
            ambient_color=((3 - e.GetSelection()) / 3,) * 3 + (1,)
        )
        self.on_light = lambda e: self.canvas.scene3d.set_style(
            light_color=((3 - e.GetSelection()) / 3,) * 3 + (1,)
        )
        self.on_shiness = lambda e: self.curobj.set_data(
            shiness=(3 - e.GetSelection()) * 20
        )
    ...
    @property
    def name(self):
        return self.canvas.scene3d.name

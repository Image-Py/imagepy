...
class ParaDialog (wx.Dialog):
    ...
    def parse(self, para) : self.funcs[para[0]](*para[1:])
    ...
    def add_num(self, rang, accu, title, key, unit):
        ...
        lab_unit = wx.StaticText( self, wx.ID_ANY, unit, wx.DefaultPosition, wx.DefaultSize, wx.ALIGN_CENTRE )
        lab_unit.Wrap( -1 )
    ...
    def add_choice(self, chos, tp, title, key, unit):
        sizer = wx.BoxSizer( wx.HORIZONTAL )
        lab_title = wx.StaticText( self, wx.ID_ANY, title, wx.DefaultPosition, wx.DefaultSize, wx.ALIGN_CENTRE )        
        lab_title.Wrap( -1 )
        sizer.Add( lab_title, 0, wx.ALIGN_CENTER|wx.ALL, 5 )
    ...
    def add_slide(self, rang, title, key, unit):
        ...
        lab_title.Wrap( -1 )
        sizer.Add( lab_title, 0, wx.ALIGN_CENTER|wx.ALL, 5 )
        ctrl = wx.Slider( self, wx.ID_ANY, 50, rang[0], rang[1], wx.DefaultPosition, wx.Size( -1,-1 ), wx.SL_HORIZONTAL|wx.SL_LABELS )
        self.ctrl_dic[key] = ctrl
